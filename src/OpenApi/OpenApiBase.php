...
/**
 * Base class for OpenAPI 3.x schemas (both 3.0 and 3.1)
 *
 * This abstract class contains shared functionality between OpenAPI 3.0 and 3.1,
 * reducing code duplication and providing a common foundation.
 */
abstract class OpenApiBase extends Schema
{
    ...
    public function __construct(array|string $data)
    {
        ...
        $this->jsonFile = $data;
        $this->specificationVersion = $this->getDefaultVersion($data);
    }

    /**
     * Get the default version for this schema type
     *
     * @param array $data
     * @return string
     */
    abstract protected function getDefaultVersion(array $data): string;

    /**
     * Get server variable default value
     * Override in subclasses for version-specific behavior
     *
     * @param array $variableDefinition
     * @return string
     */
    abstract protected function getServerVariableDefault(array $variableDefinition): string;

    /**
     * Get server URL with variable substitution
     *
     * @return string
     */
    #[\Override]
        ...
        if (isset($this->jsonFile['servers'][0]['variables'])) {
            foreach ($this->jsonFile['servers'][0]['variables'] as $var => $value) {
                if (!isset($this->serverVariables[$var])) {
                    $this->serverVariables[$var] = $this->getServerVariableDefault($value);
                }
            }
        }
    ...
    /**
     * Get the base path from the server URL
     *
     * @return string
     */
    #[\Override]
    ...
    /**
     * Validate arguments for parameters
     *
    ...
    /**
     * Get a component definition by reference path
     *
     * @param string $name
     * @return mixed
     * @throws DefinitionNotFoundException
